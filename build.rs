...
const PHP_EXTENSION_BUILD_COMMAND: &str =
    "php -i | grep 'PHP Extension Build' | sed -e 's/PHP Extension Build => //'";
const PHP_EXTENSION_BUILD_ERROR: &str =
    "Error trying to get PHP EXTENSION BUILD version from your machine";
